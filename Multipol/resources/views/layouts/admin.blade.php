...
<html>
  <head>
    ...
    <title>Ventas Ayala | @aayalaana17</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>AA</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>AA</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Ana Maria Ayala Coa</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      @aayala17 - Desarrollando Software
                      <small>aayalacoa@gmail.com</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="Ana Ayala">Ana Ayala</a>.</strong> All rights reserved.
      </footer>
